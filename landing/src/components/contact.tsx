  ...
  <div className="py-20">
    <div className="mx-auto w-full max-w-(--breakpoint-xl) px-6 xl:px-0">
      ...
      <div className="mt-16 flex flex-col gap-16 md:gap-10 lg:flex-row">
        <div className="grid w-full max-w-3xl grid-cols-1 gap-1 rounded-xl border bg-muted p-1 *:rounded-lg  *:bg-background *:p-6 sm:grid-cols-2 lg:col-span-2 dark:*:border-foreground/20">
          <div>
