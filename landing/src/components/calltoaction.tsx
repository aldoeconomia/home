  ...
  return (
    <section className="relative w-full py-0 px-0 overflow-visible pb-12">
      <div className="w-full">
        {/* Container principal */}
        <div className="relative bg-primary rounded-none flex flex-col md:flex-row items-start md:items-stretch justify-between min-h-80 md:h-1/3">
          {/* Contenido izquierdo */}
          <div className="flex-1 p-6 md:p-12 text-white z-10 flex flex-col justify-center pl-6 md:pl-12">
            ...
            <div className="w-fit">
              <Button
                asChild
                className="bg-secondary hover:bg-secondary/90 text-white font-bold uppercase tracking-widest h-10 px-6 text-sm border-none rounded-none"
              >
                <Link
